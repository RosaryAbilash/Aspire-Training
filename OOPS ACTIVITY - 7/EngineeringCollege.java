...
public class EngineeringCollege extends College{
    ...
    void display(){
        ...
        System.out.println("College Name " + super.getCollegeName());
        System.out.println("Courses Available " + super.getAvailableCourse());
        System.out.println("FEES "+super.courseFees);
