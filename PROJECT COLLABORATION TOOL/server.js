...
app.get('/signup', (req, res) => {
    res.sendFile(__dirname + '/login.html'); // Assuming login.html contains both signup and login forms
});


// Route for serving the create_project page
app.get('/create_project', (req, res) => {
  res.sendFile(__dirname + '/create_project.html'); // Replace with actual path to HTML file
});
...
app.get('/viewProject', (req, res) => {
    // Fetch projects from the database based on priority and completion date
    ...
    connection.query(query, (err, projects) => {
        ...
        // Render the view project page and pass the projects data to the template
