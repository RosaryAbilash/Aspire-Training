...
AS
BEGIN
INSERT INTO EMPLOYEES VALUES(1,'Kathiravan','Support',35000);
INSERT INTO EMPLOYEES VALUES(2,'Krish','Development',5500);
INSERT INTO EMPLOYEES VALUES(3,'Bharath','DevOps',3000);
INSERT INTO EMPLOYEES VALUES(4,'Tamil','Testing',7000);
INSERT INTO EMPLOYEES VALUES(5,'Muthu','HR',13000);
COMMIT;
END;
/
...
INSERT INTO EMPLOYEES VALUES(6,'kumar','HR',13000);
...
VALUES (1, 'Kathir', 'Dane', 'kathir@gmail.com', '9876543210', TO_DATE('2002-09-20', 'YYYY-MM-DD'), 'IT_PROG', 60000, 0.10, 1, 101);

INSERT INTO EMPLOYEES_DETAILS (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
VALUES (2, 'Krishna', 'Kumar', 'krishna@gmail.com', '9876543219', TO_DATE('2003-03-27', 'YYYY-MM-DD'), 'HR_REP', 50000, 0.05, 1, 102);

INSERT INTO EMPLOYEES_DETAILS (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
VALUES (3, 'Bharath', 'Sriram', 'Bharath@gmail.com', '9876543218', TO_DATE('2002-11-14', 'YYYY-MM-DD'), 'AD_VP', 90000, 0.06, 2, 103);

INSERT INTO EMPLOYEES_DETAILS (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
VALUES (4, 'Tamil', 'Selvan', 'Tamil@gmail.com', '9876543217', TO_DATE('2004-03-21', 'YYYY-MM-DD'), 'IT_MGR', 75000, 0.07, 3, 104);
